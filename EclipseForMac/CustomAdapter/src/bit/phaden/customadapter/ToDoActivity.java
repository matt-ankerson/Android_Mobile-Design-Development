...
public class ToDoActivity extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		// Make custom adapter
		ToDoArrayAdapter todoArrayAdapter = new ToDoArrayAdapter(this, R.layout.custom_list_view, toDoArray);
...
// Custom adapter to return layout with an ImageView and a TextView
 public class ToDoArrayAdapter extends ArrayAdapter<ToDo>
 {
	...
	public View getView(int position, View convertView, ViewGroup container) 
	{
		...
		ImageView todoImage = (ImageView)customView.findViewById(R.id.ivThumbnail);
		TextView todoText = (TextView)customView.findViewById(R.id.tvDescription);
		...
		Drawable theIcon = todoItem.toDoImage;
		String theText = todoItem.toString();
		
		todoImage.setImageDrawable(theIcon);
		todoText.setText(theText);
